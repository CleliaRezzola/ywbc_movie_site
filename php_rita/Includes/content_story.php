<div class="container">
	...
	<div class="row">
		<div class="col-md-7 context__ context__story ">
			...
			<div class="row page_name page_name__story">Plot - <a href="index.php?page=trailer">Trailer</a> - <a href="index.php?page=team">Team</a></div>

				<div class="row text plot">
					<h2>The Tell-Tale Heart</h2><br>
					...
					<h2>Dreams</h2><br>
						...
						I have been happy, tho' in a dream. <br>
